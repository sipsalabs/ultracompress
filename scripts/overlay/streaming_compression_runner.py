...
def gsq_quantize_weight(W: torch.Tensor, bpw: int,
    ...
    # Sub-sample for centroid updates
...
def get_model_classes(hf_id: str):
    ...
    Supports both Qwen3 and Qwen2/Qwen2.5 architectures.
    """
...
def compress_single_layer(
    ...
    # Extract: quantized W_base + V/U/alpha per Linear + other layer params
