...
- A simulated `huggingface-cli download` with download progress
...
- [`uc list`](list.md), [Downloading a compressed model](pull.md), [`uc info`](info.md), [`uc bench`](bench.md) — the real commands
