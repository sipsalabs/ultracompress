"""
1.7B 50K TRAINING: The headline experiment.
1.7B at 15K gave 61% T10. At 50K, projected 68-70%.
Runs on GPU 1 alongside 100K on GPU 0.
"""
...
print("=" * 70)
print("1.7B 50K TRAINING — The Headline Experiment")
print("=" * 70)
...
print(f"15K baseline: 61% T10")
print(f"50K result: {t10*100:.0f}% T10")
torch.save(model.state_dict(), 'frr_1.7b_50k_best.pt')
print("Saved frr_1.7b_50k_best.pt")
print("Done!")
