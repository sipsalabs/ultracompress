...
- `pack_all_v17.py` -- drives all 6 fits through `pack_fit`; writes `results/pack_summary.json`.
...
- `verify_all_v17.py` -- batch round-trip driver over `results/pack_summary.json`.
...
**Artifacts of record:**
- [lambada_overlay_mixed.py](lambada_overlay_mixed.py) � driver.
