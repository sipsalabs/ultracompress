...
ax1.axhline(1.8, color="#d62728", linestyle=":", linewidth=1.0, label="envelope ceiling (1.8×)")
...
ax1.set_title("Claim 16: PPL ratio at 2.40 bpw — 4 models, zero retuning", fontsize=11)
...
ax.set_title("Body bpw across 4 models — 0.3% spread at 2.40 target", fontsize=11)
