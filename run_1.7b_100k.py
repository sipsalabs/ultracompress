"""
1.7B 100K TRAINING: Push the record higher.
50K gave 66% T10 at 48x. 100K could reach 70%+.
"""
...
print("=" * 70)
print("1.7B 100K TRAINING — Push the record higher")
print("=" * 70)
...
print(f"50K baseline: 66% T10")
print(f"100K result: {t10*100:.0f}% T10")
torch.save(model.state_dict(), 'frr_1.7b_100k_best.pt')
print("Done!")
